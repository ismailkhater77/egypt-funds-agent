...
تاريخ التحليل: 2026-08-26T17:56:51.655260+00:00
...
تم احتساب التغطية حتى تاريخ التحليل `2026-08-26` فقط؛ أي snapshot ذات `valuation_date` مستقبلية لا تدخل في عدد الصناديق المغطاة حتى لو كانت حالتها `validated`. اللقطات المستقبلية القديمة الخاصة بـAzimut لم تُحذف، ولم يمكن وسمها `rejected` لأن قيد قاعدة البيانات يقصر status على القيمة الحالية `validated`; لذلك بقيت محفوظة للتدقيق، بينما يمنعها فلتر التاريخ من التأثير على التغطية الجديدة.
