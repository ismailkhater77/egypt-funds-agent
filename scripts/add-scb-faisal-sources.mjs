...
const sources = [
  ...
  { source_id: 'src_ebank_market_updates', source_name: 'EBank Official Market Updates Funds', source_url: 'https://ebank.com.eg/market-updates/', source_kind: 'official_bank_fund_rates', active: true },
