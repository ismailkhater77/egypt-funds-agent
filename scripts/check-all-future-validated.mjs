...
const priceResponse = await fetch(`${base}/rest/v1/fund_prices?valuation_date=gt.2026-08-26&select=id,source_id,fund_id,nav,currency,valuation_date,status,parser_name&order=valuation_date.asc`, { headers });
